...
public class DatabaseHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		String sql = "CREATE TABLE [accounts] ([id] INT, [date_] DATE, [item] VARCHAR(50), [category] TINYINT, [money] DOUBLE, [note] VARCHAR(100), CONSTRAINT [sqlite_autoindex_accounts_1] PRIMARY KEY ([id]))";
		// execSQL用于执行SQL语句
		db.execSQL(sql);
	}
